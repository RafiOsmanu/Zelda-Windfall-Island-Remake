...
protected:
	...
	//CUSTOM DEPTH FUNCTION BASECOMPONENT
	virtual void DepthMapDraw(const SceneContext&) {} //update_W9
	...
	//CUSTOM DEPTH VARIABLE BASECOMPONENT
	bool m_enableDepthMapDraw{ false };
